    ...
    return (
        <>
            <div>
                ...
                <NavLink exact to='/login' style={{textDecoration:"none", color:"white", fontSize:"15px", fontFamily: 'League Spartan, sans-serif'}}>LOGIN</NavLink> &nbsp; &nbsp;
                <NavLink to='/signup' style={{textDecoration:"none", color:"white", fontSize:"15px", fontFamily: 'League Spartan, sans-serif'}}>SIGNUP</NavLink> &nbsp; &nbsp;
                </div>
            </div>
        </>
    );
